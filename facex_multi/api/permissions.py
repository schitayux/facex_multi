...
def _children(company: str, child_doctype: str, fields: list) -> list:
    ...
    if key not in cache:
        cache[key] = frappe.get_all(
            ...
            fields=fields,
            # Orden del grid: «la primera bodega permitida» (fallback de
            # Compras) es la primera fila que el administrador ve.
            order_by="idx asc",
        )
    return cache[key]
...
PROFILE_PERM_FIELDS = [
    ...
    "reporte_estados_cuenta",
    "reporte_antiguedad_saldos",
    "reporte_cotizaciones",
    "reporte_recibos_pagos",
    "reporte_crecimiento_ventas",
    ...
    "entrada_grabar_borrador",
    "entrada_validar_confirmar",
    "salida_grabar_borrador",
